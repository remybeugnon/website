...
title: Biodiversity - Microclimate - Ecosystem Functioning (BM-E-F) nexus
authors:
- admin 
image:
  caption: "Soil temperature sensors"
  focal_point: Smart
summary: "B-M-EF project: linking diversity, microclimate and ecosystem functioning"
tags:
- BEF
- Soil
- Microclimate
...
The B-M-EF project is aiming to quantify and understand vegetation diversity modulate micrlcimate and the consequences for ecosystem functioning. This project is based on our collaboration with the international <a href="https://meb-network.com/">MEB network</a>, which is compiling near surface microclimate measurements around the world, across biomes and ecosystems.
</div>
